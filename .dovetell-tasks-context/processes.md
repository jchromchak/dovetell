# processes.md
# Dogfood POC — Business Processes
...
- process-[8char]
  ...
  steps:
    1. [step description]
       ...
       updated: YYYY-MM-DDTHH:mm:ssZ (codex-[hash] | prompt-[hash])
  ...
  version-history:
    - YYYY-MM-DDTHH:mm:ssZ (codex-[hash] | prompt-[hash]): [what changed and why]
