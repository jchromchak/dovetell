...
The answer becomes <project-name> and drives the context folder path:
...
- Reference relevant file types by name (.<project-name>-context/[file])
...
- .<project-name>-context/launcher.md
- .<project-name>-context/session-handoff.md
- .<project-name>-context/[only the files relevant to this task]
...
*prompt-shaper.md — Dogfood POC — v0.1*
